...
# Hand-written code should be added in a separate file named DUCK_Smart_Blur_v1Ext.py
...
try:
    from DUCK_Smart_Blur_v1Ext import *
except ImportError:
    pass

def getPluginID():
    return "DUCK_Smart_Blur_v1"
...
def createInstance(app,group):
    ...
    param = lastNode.createSeparatorParam("DUCK_Smart_Blur_v1", "DUCK_Smart_Blur_v1")
    ...
    param.setEvaluateOnChange(False)
    lastNode.DUCK_Smart_Blur_v1 = param
    del param
    ...
    param = lastNode.createSeparatorParam("line02", "DUCK_Smart_Blur_v1")
    ...
    try:
        extModule = sys.modules["DUCK_Smart_Blur_v1Ext"]
    except KeyError:
        extModule = None
