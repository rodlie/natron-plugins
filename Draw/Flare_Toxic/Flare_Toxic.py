...
# Hand-written code should be added in a separate file named Flare_ToxicExt.py
...
try:
    from Flare_ToxicExt import *
except ImportError:
    pass

def getPluginID():
    return "natron.community.plugins.Flare_Toxic"
...
def createInstance(app,group):
    ...
    param.setValue(243, 0)
    param.setValue(894, 1)
    ...
    param.setAddNewLine(True)
    param.setAnimationEnabled(True)
    param.setValue(0.3613067865371704, 0)
    param.setValue(0.7605246305465698, 1)
    ...
    param = lastNode.getParam("paramValueFloat2")
    if param is not None:
        param.setValueAtTime(0.854, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat2")
    if param is not None:
        param.setValueAtTime(0.386, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat3")
    if param is not None:
        param.setValueAtTime(0.189, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat4")
    if param is not None:
        param.setValueAtTime(0.292, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat2")
    if param is not None:
        param.setValueAtTime(1.441, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat2")
    if param is not None:
        param.setValueAtTime(0.041, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat10")
    if param is not None:
        param.setValueAtTime(49.99999999999999, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueFloat3")
    if param is not None:
        param.setValueAtTime(0.708, 1, 0)
        del param
    ...
    del lastNode
    # End of node "Anamorphic_Spots_3"

    # Start of node "Sun_2_2_2"
    lastNode = app.createNode("net.sf.openfx.Shadertoy", 1, group)
    lastNode.setScriptName("Sun_2_2_2")
    lastNode.setLabel("Sun_2")
    lastNode.setPosition(181, 193)
    lastNode.setSize(104, 44)
    lastNode.setColor(0.3, 0.5, 0.2)
    ...
    param = lastNode.getParam("paramValueFloat2")
    if param is not None:
        param.setValueAtTime(0.352, 1, 0)
        del param
    ...
    param = lastNode.getParam("paramValueVec313")
    if param is not None:
        param.setValueAtTime(0.1912016570568085, 1, 0)
        param.setValueAtTime(0.08021982759237289, 1, 1)
        param.setValueAtTime(1, 1, 2)
        del param
    ...
    # Start of node "Sun_2_2_2_3"
    lastNode = app.createNode("net.sf.openfx.Shadertoy", 1, group)
    lastNode.setScriptName("Sun_2_2_2_3")
    lastNode.setLabel("Sun_2_3")
    lastNode.setPosition(181, 258)
    lastNode.setSize(104, 44)
    lastNode.setColor(0.3, 0.5, 0.2)
    groupSun_2_2_2_3 = lastNode
    ...
    param = lastNode.getParam("paramValueVec315")
    if param is not None:
        param.setValueAtTime(0.001517634955234826, 1, 0)
        param.setValueAtTime(1, 1, 1)
        param.setValueAtTime(0.02732088789343834, 1, 2)
        del param
    ...
    param = lastNode.getParam("paramValueVec316")
    if param is not None:
        param.setValueAtTime(0.01298303063958883, 1, 0)
        param.setValueAtTime(0.06301002204418182, 1, 1)
        param.setValueAtTime(1, 1, 2)
        del param
    ...
    param = lastNode.getParam("imageShaderPreset")
    if param is not None:
        param.set("Lens Flare Elements/anmorpic_Ghost_multiLayer")
        del param
    ...
    groupAnamorphic_Spots.connectInput(0, groupAnamorphic_Spots_3)
    groupAnamorphic_Spots_2.connectInput(0, groupAnamorphic_Spots)
    ...
    groupStar.connectInput(0, groupSun_2_2_2_3)
    groupAnamorphic_ghost_Single.connectInput(0, groupGlimmer)
    groupAnamorphic_ghost_Single_2.connectInput(0, groupAnamorphic_ghost_Single)
    groupAnamorphic_Spots_3.connectInput(0, groupAnamorphic_ghost_Single_2)
    groupSun_2_2_2.connectInput(0, groupSun_2_2)
    groupSun_2_2_2_3.connectInput(0, groupSun_2_2_2)
    ...
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 1)
    del param
    param = groupAnamorphic_Spots.getParam("paramValueFloat0")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat0"), 0, 0)
    del param
    param = groupAnamorphic_Spots.getParam("paramValueFloat1")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat1"), 0, 0)
    del param
    ...
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat1"), 0, 0)
    del param
    param = groupAnamorphic_Spots_3.getParam("mousePosition")
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 0)
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 1)
    del param
    param = groupAnamorphic_Spots_3.getParam("paramValueFloat0")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat0"), 0, 0)
    del param
    param = groupAnamorphic_Spots_3.getParam("paramValueFloat1")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat1"), 0, 0)
    del param
    ...
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 1)
    del param
    param = groupSun_2_2_2.getParam("paramValueFloat0")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat0"), 0, 0)
    del param
    param = groupSun_2_2_2.getParam("paramValueFloat1")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat1"), 0, 0)
    del param
    param = groupSun_2_2_2_3.getParam("mousePosition")
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 0)
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 1)
    del param
    param = groupSun_2_2_2_3.getParam("paramValueFloat0")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat0"), 0, 0)
    del param
    param = groupSun_2_2_2_3.getParam("paramValueFloat1")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat1"), 0, 0)
    del param
    ...
    del param
    try:
        extModule = sys.modules["Flare_ToxicExt"]
    except KeyError:
        extModule = None
