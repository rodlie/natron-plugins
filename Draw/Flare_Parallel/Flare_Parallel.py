...
# Hand-written code should be added in a separate file named Flare_ParallelExt.py
...
try:
    from Flare_ParallelExt import *
except ImportError:
    pass

def getPluginID():
    return "natron.community.plugins.Flare_Parallel"

def getLabel():
    return "Flare_Parallel"
...
def createInstance(app,group):
    ...
    groupGlimmer.connectInput(0, groupRing_2)
    groupAnamorphic_Spots.connectInput(0, groupAnamorphic_Spots_3)
    groupAnamorphic_Spots_2.connectInput(0, groupAnamorphic_Spots)
    groupHoop.connectInput(0, groupAnamorphic_Spots_2)
    groupStar.connectInput(0, groupSun_2_2_2)
    ...
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat1"), 0, 0)
    del param
    param = groupRing_2.getParam("mousePosition")
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 0)
    param.setExpression("thisGroup.TrackLinkXY.get()[dimension]", False, 1)
    del param
    param = groupRing_2.getParam("paramValueFloat0")
    param.slaveTo(group.getParam("ROOT_GLOBALparamValueFloat0"), 0, 0)
    del param
    ...
    del param
    try:
        extModule = sys.modules["Flare_ParallelExt"]
    except KeyError:
        extModule = None
