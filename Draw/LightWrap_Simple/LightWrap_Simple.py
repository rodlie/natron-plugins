...
# Hand-written code should be added in a separate file named LightWrap_SimpleExt.py
...
try:
    from LightWrap_SimpleExt import *
except ImportError:
    pass

def getPluginID():
    return "natron.comunity.plugins.lightwrap_simple"

def getLabel():
    return "LightWrap_Simple"
...
def createInstance(app,group):
    ...
    try:
        extModule = sys.modules["LightWrap_SimpleExt"]
    except KeyError:
        extModule = None
