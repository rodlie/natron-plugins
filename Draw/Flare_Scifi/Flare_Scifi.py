...
# Hand-written code should be added in a separate file named Flare_ScifiExt.py
...
try:
    from Flare_ScifiExt import *
except ImportError:
    pass

def getPluginID():
    return "natron.community.plugins.Flare_Scifi"
...
def createInstance(app,group):
    ...
    param.setValue(336, 0)
    param.setValue(883, 1)
    ...
    param = lastNode.getParam("paramValueFloat8")
    if param is not None:
        param.setValueAtTime(0.061, 1, 0)
        del param
    ...
    del param
    try:
        extModule = sys.modules["Flare_ScifiExt"]
    except KeyError:
        extModule = None
