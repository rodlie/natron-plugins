...
# Hand-written code should be added in a separate file named bl_MonochromeExt.py
...
try:
    from bl_MonochromeExt import *
except ImportError:
    pass

def getPluginID():
    return "natron.community.plugins.bl_Monochrome"

def getLabel():
    return "bl_Monochrome"

def getVersion():
    return 1.0

def getIconPath():
    return "bl_Monochrome.png"

def getGrouping():
    return "Community/BL/Color"

def getPluginDescription():
    return "Same as the Shake's Monochrome node. You can play independently with the 3 color component."
...
def createInstance(app,group):
    ...
    param = lastNode.createColorParam("Multiply3value", "Value : ", True)
    ...
    param = lastNode.createSeparatorParam("NAME", "bl_Monochrome v1.0")
    ...
    lastNode.setPosition(4139, 3754)
    lastNode.setSize(80, 32)
    ...
    # Start of node "Expression12"
    lastNode = app.createNode("fr.inria.openfx.SeExprSimple", 2, group)
    lastNode.setScriptName("Expression12")
    lastNode.setLabel("Expression12")
    lastNode.setPosition(4139, 3883)
    lastNode.setSize(80, 32)
    lastNode.setColor(1, 1, 1)
    groupExpression12 = lastNode
    ...
    # Start of node "Expression13"
    lastNode = app.createNode("fr.inria.openfx.SeExprSimple", 2, group)
    lastNode.setScriptName("Expression13")
    lastNode.setLabel("Expression13")
    lastNode.setPosition(3938, 4012)
    lastNode.setSize(80, 32)
    lastNode.setColor(1, 1, 1)
    groupExpression13 = lastNode
    ...
    del lastNode
    # End of node "Expression13"

    # Start of node "Merge1"
    lastNode = app.createNode("net.sf.openfx.MergePlugin", 1, group)
    lastNode.setScriptName("Merge1")
    lastNode.setLabel("Merge1")
    lastNode.setPosition(4139, 4001)
    ...
    groupMultiply3.connectInput(0, groupSource)
    groupExpression12.connectInput(0, groupMultiply3)
    groupFill1.connectInput(0, groupMultiply3)
    groupExpression13.connectInput(0, groupFill1)
    groupMerge1.connectInput(0, groupExpression13)
    groupMerge1.connectInput(1, groupExpression12)

    param = groupMultiply3.getParam("value")
    group.getParam("Multiply3value").setAsAlias(param)
    del param
    ...
    try:
        extModule = sys.modules["bl_MonochromeExt"]
    except KeyError:
        extModule = None
