...
def createInstance(app,group):
    ...
    lastNode = group
    lastNode.setColor(0.2549, 0.4902, 1)
    ...
    lastNode.setPagesOrder(['userNatron', 'grain_ctrl', 'Node', 'Settings'])
    ...
    lastNode.setPosition(1720, 1435)
    ...
    lastNode.setPosition(2022, 1862)
    lastNode.setSize(15, 15)
    lastNode.setColor(0.7, 0.7, 0.7)
    groupDot7 = lastNode
    ...
    # Start of node "Shuffle45"
    lastNode = app.createNode("net.sf.openfx.ShufflePlugin", 3, group)
    lastNode.setScriptName("Shuffle45")
    lastNode.setLabel("Shuffle2")
    lastNode.setPosition(1708, 1643)
    lastNode.setSize(104, 32)
    lastNode.setColor(0.6, 0.24, 0.39)
    groupShuffle45 = lastNode
    ...
    del lastNode
    # End of node "Shuffle45"

    # Start of node "Shuffle45_2"
    lastNode = app.createNode("net.sf.openfx.ShufflePlugin", 3, group)
    lastNode.setScriptName("Shuffle45_2")
    lastNode.setLabel("Shuffle2_2")
    lastNode.setPosition(1844, 1853)
    lastNode.setSize(104, 32)
    lastNode.setColor(0.6, 0.24, 0.39)
    groupShuffle45_2 = lastNode
    ...
    groupDot3.connectInput(0, groupShuffle6)
    ...
    groupSwitch4.connectInput(0, groupShuffle4)
    groupSwitch4.connectInput(1, groupDot42)
    groupDot42.connectInput(0, groupPremult1)
    groupPremult1.connectInput(0, groupShuffle45_2)
    ...
    groupDot13.connectInput(0, groupShuffle45)
    ...
    groupShuffle6.connectInput(0, groupDot1)
    groupShuffle6.connectInput(1, groupDot11)
    groupShuffle45.connectInput(0, groupSeGrain1)
    groupShuffle45.connectInput(1, groupDot22)
    groupShuffle45_2.connectInput(0, groupDot4)
    groupShuffle45_2.connectInput(1, groupDot7)
    groupShuffle4.connectInput(0, groupMerge4_2)
    groupShuffle4.connectInput(1, groupDot10)
