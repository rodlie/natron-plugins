...
def createInstance(app,group):
    ...
    # Set param properties
    param.setHelp("lp_roughenEdges v1.0\n(c)2016 lucas pfaff")
    param.setAddNewLine(True)
    param.setEvaluateOnChange(False)
    param.setAnimationEnabled(False)
    ...
    groupSeNoise1.connectInput(0, groupShuffle1)
    ...
    groupShuffle1.connectInput(0, groupConstant1)
    groupShuffle1.connectInput(1, groupDot2)
    groupDot3.connectInput(0, groupSeNoise1)
    groupConstant1.connectInput(0, groupDot2)
