...
# Hand-written code should be added in a separate file named lp_FeatherAdvancedExt.py
...
try:
    from lp_FeatherAdvancedExt import *
except ImportError:
    pass

def getPluginID():
    return "lp_FeatherAdvanced"
...
def createInstance(app,group):
    ...
    try:
        extModule = sys.modules["lp_FeatherAdvancedExt"]
    except KeyError:
        extModule = None
