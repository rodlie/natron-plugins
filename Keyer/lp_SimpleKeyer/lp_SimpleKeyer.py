...
def createInstance(app,group):
    ...
    lastNode.setPosition(3261, 2159)
    ...
    lastNode.setPosition(3261, 1264)
    lastNode.setSize(104, 43)
    lastNode.setColor(0.48, 0.66, 1)
