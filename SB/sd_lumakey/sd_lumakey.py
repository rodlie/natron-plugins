...
# Hand-written code should be added in a separate file named sd_lumakeyExt.py
...
try:
    from sd_lumakeyExt import *
except ImportError:
    pass

def getPluginID():
    return "natron.community.plugins.sd_lumakey"
...
def createInstance(app,group):
    ...
    param = lastNode.createSeparatorParam("NAME", "sd_lumakey v1.0")
    ...
    try:
        extModule = sys.modules["sd_lumakeyExt"]
    except KeyError:
        extModule = None
