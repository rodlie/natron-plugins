...
### GLSL/Keying
- <img src='/GLSL/Keyer/AFX_Despill_GL/AFX_Despill_GL.png' width='32'> **[AFX_Despill_GL](/GLSL/Keyer/AFX_Despill_GL/README.md)** : GPU accelerated After Effects despill for Shadertoy.

- <img src='/GLSL/Keyer/Crok_chromakey_GL/Crok_chromakey_GL.png' width='32'> **[Crok_chromakey_GL](/GLSL/Keyer/Crok_chromakey_GL/README.md)** : This shader does a fast chroma key.

- <img src='/GLSL/Keyer/Crok_despill_GL/Crok_despill_GL.png' width='32'> **[Crok_despill_GL](/GLSL/Keyer/Crok_despill_GL/README.md)** : Combines multiple LogicOps to streamline your keying node graph.

- <img src='/GLSL/Keyer/Crok_difference_GL/Crok_difference_GL.png' width='32'> **[Crok_difference_GL](/GLSL/Keyer/Crok_difference_GL/README.md)** : Creates a diference matte.

- <img src='/GLSL/Keer/Crok_edge_matte_GL/Crok_edge_matte_GL.png' width='32'> **[Crok_edge_matte_GL](/GLSL/Keyer/Crok_edge_matte_GL/README.md)** : GPU accelerated edge detect effect for Shadertoy.

- <img src='/GLSL/Keyer/Cryptomatte_GL/Cryptomatte_GL.png' width='24'> **[Cryptomatte_GL](/GLSL/Keyer/Cryptomatte_GL/README.md)** : Extract up to four mattes from the ID/coverage pairs generated by Arnold/Clarisse/Mantra's Cryptomatte shaders.

- <img src='/GLSL/Keyer/JB_autoMatte_GL/JB_autoMatte_GL.png' width='32'> **[JB_autoMatte_GL](/GLSL/Keyer/JB_autoMatte_GL/README.md)** : Creates a RGB multimattes of an input which can be useful to mockup quick keys.

- <img src='/GLSL/Keyer/JB_erodematte_GL/JB_erodematte_GL.png' width='32'> **[JB_erodematte_GL](/GLSL/Keyer/JB_erodematte_GL/README.md)** : Simple erode node.
