...
def createInstance(app,group):
    ...
    param = lastNode.createSeparatorParam("Money_Filter_GL", "Money_Filter_GL")
    ...
    param.setEvaluateOnChange(False)
    lastNode.Money_Filter_GL = param
    del param
    ...
    param = lastNode.createSeparatorParam("line02", "Money_Filter_GL")
