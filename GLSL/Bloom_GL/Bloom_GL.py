...
def createInstance(app,group):
    ...
    param = lastNode.createSeparatorParam("Bloom_GL", "Bloom_GL")
    ...
    param = lastNode.createSeparatorParam("line02", "Bloom_GL v1.0")
    ...
    groupShadertoy1_2.connectInput(0, grouprgb)
