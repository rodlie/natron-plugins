...
# Hand-written code should be added in a separate file named Crok_NaNfix_GLExt.py
...
def createInstance(app,group):
    ...
    param = lastNode.createSeparatorParam("NAME", "Crok_NaNfix_GL v1.0")
    ...
    groupShadertoy1_2.connectInput(0, grouprgba)
    ...
    try:
        extModule = sys.modules["Crok_NaNfix_GLExt"]
    except KeyError:
        extModule = None
