...
# Hand-written code should be added in a separate file named JB_autoMatte_GLExt.py
...
try:
    from JB_autoMatte_GLExt import *
except ImportError:
    pass

def getPluginID():
    return "natron.community.plugins.JB_autoMatte_GL"

def getLabel():
    return "JB_autoMatte_GL"

def getVersion():
    return 1.0

def getIconPath():
    return "JB_autoMatte_GL.png"

def getGrouping():
    return "Community/GLSL/Keying"

def getPluginDescription():
    return "Creates a RGB multimattes of an input which can be useful to mockup quick keys."
...
def createInstance(app,group):
    ...
    param = lastNode.createBooleanParam("Shadertoy1paramValueBool0", "Ponderate : ")
    ...
    param = lastNode.createSeparatorParam("NAME", "JB_autoMatte_GL v1.0")
    ...
    lastNode.setScriptName("ID")
    lastNode.setLabel("ID")
    lastNode.setPosition(4136, 3692)
    lastNode.setSize(90, 36)
    ...
    lastNode.setPosition(4136, 3909)
    lastNode.setSize(90, 36)
    lastNode.setColor(0.3, 0.5, 0.2)
    ...
    groupShadertoy1.connectInput(0, groupID)
    ...
    try:
        extModule = sys.modules["JB_autoMatte_GLExt"]
    except KeyError:
        extModule = None
