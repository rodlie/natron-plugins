...
def createInstance(app,group):
    ...
    param = lastNode.createSeparatorParam("Crok_pixelate_GL", "Crok_pixelate_GL")
    ...
    param.setEvaluateOnChange(False)
    lastNode.Crok_pixelate_GL = param
    del param
    ...
    param = lastNode.createSeparatorParam("line02", "Crok_pixelate_GL v1.0")
