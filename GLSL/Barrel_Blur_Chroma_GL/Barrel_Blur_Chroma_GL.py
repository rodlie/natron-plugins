...
def createInstance(app,group):
    ...
    param = lastNode.createSeparatorParam("Barrel_Blur_Chroma_GL", "Barrel_Blur_Chroma_GL")
    ...
    param.setEvaluateOnChange(False)
    lastNode.Barrel_Blur_Chroma_GL = param
    del param
    ...
    param = lastNode.createSeparatorParam("line02", "Barrel_Blur_Chroma_GL v1.0")
    ...
    group.getParam("Samples").setAsAlias(param)
    del param
    param = groupShadertoy2.getParam("paramValueBool2")
    group.getParam("Modulate").setAsAlias(param)
    del param
